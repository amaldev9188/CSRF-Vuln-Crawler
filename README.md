...
### 1. Run a Local Server to Host the Proof of Concept (PoC)
To test the crawler locally, start a local HTTP server in the repository directory:
```bash
python -m http.server 8000
```
This will host [poc.html](file:///c:/Users/Amal/Documents/Crawler/poc.html) at `http://localhost:8000/poc.html`.

### 2. Run the Crawler Script
Open another terminal, run the crawler script, and enter the target URL when prompted:
```bash
python crawler.py
```
...
**Local HTTP Server Terminal Log:**
```text
PS C:\Users\Amal\Documents\Crawler> python -m http.server 8000
Serving HTTP on :: port 8000 (http://[::]:8000/) ...
::ffff:127.0.0.1 - - [20/Jul/2026 12:40:11] "GET / HTTP/1.1" 200 -
::ffff:127.0.0.1 - - [20/Jul/2026 12:40:12] code 404, message File not found
::ffff:127.0.0.1 - - [20/Jul/2026 12:40:12] "GET /favicon.ico HTTP/1.1" 404 -
::ffff:127.0.0.1 - - [20/Jul/2026 12:40:15] "GET /poc.html HTTP/1.1" 200 -
::ffff:127.0.0.1 - - [20/Jul/2026 12:40:21] "GET /poc.html?username=&password= HTTP/1.1" 200 -
::1 - - [20/Jul/2026 12:41:18] "GET /poc.html?username=&password= HTTP/1.1" 200 -
```

**Crawler Terminal Input/Output:**
```text
Enter the URL to crawl: http://localhost:8000/poc.html?username=&password=
